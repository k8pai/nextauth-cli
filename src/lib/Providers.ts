		...
		importOptions: [
			{
				...
				authName: 'Apple',
				authPath: '@auth/core/providers/apple',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Asgardeo',
				authPath: '@auth/core/providers/asgardeo',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Atlassian',
				authPath: '@auth/core/providers/atlassian',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Auth0',
				authPath: '@auth/core/providers/auth0',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Authentik',
				authPath: '@auth/core/providers/authentik',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'AzureAD',
				authPath: '@auth/core/providers/azure-ad',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'AzureB2C',
				authPath: '@auth/core/providers/azure-ad-b2c',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'AzureDevOps',
				authPath: '@auth/core/providers/azure-devops',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'BattleNet',
				authPath: '@auth/core/providers/battlenet',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'BeyondIdentity',
				authPath: '@auth/core/providers/beyondidentity',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Box',
				authPath: '@auth/core/providers/box',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'BoxyHQSAML',
				authPath: '@auth/core/providers/boxyhq-saml',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Bungie',
				authPath: '@auth/core/providers/bungie',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Cognito',
				authPath: '@auth/core/providers/cognito',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Coinbase',
				authPath: '@auth/core/providers/coinbase',
			},
		],
		...
		importOptions: [
			{
				...
				authPath: '@auth/core/providers/credentials',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Descope',
				authPath: '@auth/core/providers/descope',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Dribbble',
				authPath: '@auth/core/providers/dribbble',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Discord',
				authPath: '@auth/core/providers/discord',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Dropbox',
				authPath: '@auth/core/providers/dropbox',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'DuendeIDS6',
				authPath: '@auth/core/providers/duende-identity-server6',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Email',
				authPath: '@auth/core/providers/email',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Eveonline',
				authPath: '@auth/core/providers/eveonline',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Facebook',
				authPath: '@auth/core/providers/facebook',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Faceit',
				authPath: '@auth/core/providers/faceit',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'FortyTwoSchool',
				authPath: '@auth/core/providers/school',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Foursquare',
				authPath: '@auth/core/providers/foursquare',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Freshbooks',
				authPath: '@auth/core/providers/freshbooks',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Fusionauth',
				authPath: '@auth/core/providers/fusionauth',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'GitHub',
				authPath: '@auth/core/providers/github',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Gitlab',
				authPath: '@auth/core/providers/gitlab',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Google',
				authPath: '@auth/core/providers/google',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Hubspot',
				authPath: '@auth/core/providers/hubspot',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'IdentityServer4',
				authPath: '@auth/core/providers/identity-server4',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Instagram',
				authPath: '@auth/core/providers/instagram',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Kakao',
				authPath: '@auth/core/providers/kakao',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Keycloak',
				authPath: '@auth/core/providers/keycloak',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Line',
				authPath: '@auth/core/providers/line',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'LinkedIn',
				authPath: '@auth/core/providers/linkedin',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Mailchimp',
				authPath: '@auth/core/providers/mailchimp',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Mailru',
				authPath: '@auth/core/providers/mailru',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Mastodon',
				authPath: '@auth/core/providers/mastodon',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Mattermost',
				authPath: '@auth/core/providers/mattermost',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Medium',
				authPath: '@auth/core/providers/medium',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Naver',
				authPath: '@auth/core/providers/naver',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Notion',
				authPath: '@auth/core/providers/notion',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Netlify',
				authPath: '@auth/core/providers/netlify',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Okta',
				authPath: '@auth/core/providers/okta',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Onelogin',
				authPath: '@auth/core/providers/onelogin',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Osso',
				authPath: '@auth/core/providers/osso',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Osu',
				authPath: '@auth/core/providers/osu',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Passage',
				authPath: '@auth/core/providers/passage',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Patreon',
				authPath: '@auth/core/providers/patreon',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Pinterest',
				authPath: '@auth/core/providers/pinterest',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Pipedrive',
				authPath: '@auth/core/providers/pipedrive',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Reddit',
				authPath: '@auth/core/providers/reddit',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Salesforce',
				authPath: '@auth/core/providers/salesforce',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Slack',
				authPath: '@auth/core/providers/slack',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Spotify',
				authPath: '@auth/core/providers/spotify',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Strava',
				authPath: '@auth/core/providers/strava',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Tiktok',
				authPath: '@auth/core/providers/tiktok',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Todoist',
				authPath: '@auth/core/providers/todoist',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Trakt',
				authPath: '@auth/core/providers/trakt',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Twitch',
				authPath: '@auth/core/providers/twitch',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Twitter',
				authPath: '@auth/core/providers/twitter',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'UnitedEffects',
				authPath: '@auth/core/providers/united-effects',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Vk',
				authPath: '@auth/core/providers/vk',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Wikimedia',
				authPath: '@auth/core/providers/wikimedia',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Wordpress',
				authPath: '@auth/core/providers/wordpress',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'WorkOS',
				authPath: '@auth/core/providers/workos',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Yandex',
				authPath: '@auth/core/providers/yandex',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Zitadel',
				authPath: '@auth/core/providers/zitadel',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Zoho',
				authPath: '@auth/core/providers/zoho',
			},
		],
		...
		importOptions: [
			{
				...
				authName: 'Zoom',
				authPath: '@auth/core/providers/zoom',
			},
		],
